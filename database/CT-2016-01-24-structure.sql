...
CREATE TABLE `law_timeline` (
  ...
  `law_id` int(11) unsigned NOT NULL,
  `law_timeline_status_id` int(11) unsigned DEFAULT NULL,
...
/*Table structure for table `law_timeline_status` */

DROP TABLE IF EXISTS `law_timeline_status`;

CREATE TABLE `law_timeline_status` (
  `law_timeline_status_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT NULL,
  `icon` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`law_timeline_status_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
