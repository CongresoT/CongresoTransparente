...
<script type='text/javascript'>
	...
	var message_delete_list = "<?php echo $this->l('delete_list'); ?>";
...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<?php if(!$unset_add || !$unset_export || !$unset_print || (!$unset_multi && !$unset_delete)){?>
	<div class="tDiv">
		<div class="tDiv2">
		<?php if(!$unset_add){?>
		...
		<?php }?>
		<?php if(!$unset_multi && !$unset_delete){?>
        	<a href='<?php echo $delete_url?>' title='<?php echo $this->l('list_delete'); ?> <?php echo $subject?>' class='add-anchor add_button delete-row'>
			<div class="fbutton">
				<div>
					<span class="delete"><?php echo $this->l('list_delete'); ?> <?php echo $subject?></span>
				</div>
			</div>
            </a>
			<div class="btnseparator">
