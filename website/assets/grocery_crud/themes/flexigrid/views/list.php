...
?><div class="bDiv" >
		...
		<thead>
			<tr class='hDiv'>
				...
				<th align="left" abbr="tools" axis="col1" class="" width="19%">
					<div class="text-right">
...
<?php foreach($list as $num_row => $row){ ?>        
		<tr  <?php if($num_row % 2 == 1){?>class="erow"<?php }?>>
			...
			<td align="left" width='1%'>
				<div>				
				<input type="checkbox" value="<?php echo $row->multi_primary_key_value; ?>" class="multi-row" />
				</div>
			</td>
			<?php }?>
