...
|
*/
$config['base_url']	= '<http://your.project.url/>';
...
|
*/
$config['encryption_key'] = 'freequent';
...
$config['csrf_token_name'] = 'sq_token';
$config['csrf_cookie_name'] = 'sq_cookie';
...
setlocale(LC_ALL, 'es_ES.utf8', 'es_ES@euro', 'es_ES', 'es', 'spanish', 'Spanish_Spain.65001');
